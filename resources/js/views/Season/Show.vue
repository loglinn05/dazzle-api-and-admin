<template>
    <Layout>
        ...
        />
        <DataTable
            :value="currentSeason.tableFormat"
            ...
            <template #header>
                ...
                >
                    <Button
                        ...
                        raised
                        @click="
                            $router.push(`/season/${$route.params.id}/edit`)
                        "
                    />
                    <Button
                        v-if="
...
const { getSeason, clearCurrentSeason, deleteSeason } = seasonsStore;
